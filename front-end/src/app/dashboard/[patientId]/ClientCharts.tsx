...
const chartsConfig = [
    { title: "Walking Asymmetry", color: "var(--red-alert)", dataKey: "Walking Asymmetry", unit: "%" },
    { title: "Respiratory Rate", color: "var(--purple-accent)", dataKey: "Respiratory Rate", unit: " rpm" },
    { title: "Resting Heart Rate", color: "var(--purple-primary)", dataKey: "Resting Heart Rate", unit: " bpm" },
    { title: "Wrist Temp (Δ°C)", color: "var(--purple-accent)", dataKey: "Wrist Temp (Δ°C)", unit: "°" },
];
