        ...
        return (
          <motion.div
            ...
            style={{
              ...
              boxShadow: isOpen
                ? "0 4px 16px rgba(93,46,168,0.10)"
                : "0 2px 8px rgba(93,46,168,0.04)",
                ...
                <span
                  ...
                  style={{
                    background: isTopMatch
                      ? "linear-gradient(135deg, rgba(93,46,168,0.18), rgba(242,148,185,0.18))"
                      : "var(--lavender-bg)",
                    color: isTopMatch ? "var(--purple-primary)" : "var(--text-muted)",
                    border: isTopMatch ? "1px solid rgba(93,46,168,0.20)" : "1px solid var(--lavender-border)",
                  }}
                >
                  {i + 1}
                </span>
