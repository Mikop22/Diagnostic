                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    ...
                    <motion.div
                        ...
                        style={{
                            ...
                            boxShadow:
                                "0 8px 40px rgba(93,46,168,0.12), 0 2px 12px rgba(93,46,168,0.06), inset 0 1px 0 rgba(255,255,255,0.6), inset 0 -1px 0 rgba(232,222,248,0.2)",
                        }}
                    >
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <input
                                        ...
                                        className="h-11 rounded-[14px] border border-white/40 bg-white/30 px-4 text-[14px] text-[var(--text-primary)] placeholder:text-[var(--text-muted)] outline-none backdrop-blur-sm transition-all focus:border-[var(--purple-primary)] focus:bg-white/50 focus:shadow-[0_0_0_3px_rgba(93,46,168,0.08)]"
                                    />
                                </div>
