                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input
                                            ...
                                            className="h-11 rounded-[14px] border border-white/40 bg-white/30 px-4 text-[14px] text-[var(--text-primary)] outline-none backdrop-blur-sm transition-all focus:border-[var(--purple-primary)] focus:bg-white/50 focus:shadow-[0_0_0_3px_rgba(93,46,168,0.08)]"
                                        />
                                    </div>
