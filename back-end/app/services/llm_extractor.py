...
4. Evidence-based recommended diagnostic actions, aggressively weighing their explicit demographic, ancestral, and comorbidity risk factors.
5. Generating exactly 5 targeted, high-yield guiding questions the physician should ask the patient to immediately rule out or confirm the most critical conditions.
